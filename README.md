...
inside the shell. Persisted session memory is owner-only on read and write, and
redacts common API keys, bearer tokens, and URL credentials before writing to disk. The CLI
