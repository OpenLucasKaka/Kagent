...
(0, node_test_1.default)("expands a tilde-prefixed KAGENT_HOME and makes relative overrides absolute", () => {
    ...
    strict_1.default.equal((0, kagent_home_1.resolveKagentHome)({ HOME: home, KAGENT_HOME: "~\\shared-kagent" }), node_path_1.default.resolve("~\\shared-kagent"));
});
...
(0, node_test_1.default)("fails clearly when HOME is required but missing or blank", () => {
    strict_1.default.throws(() => (0, kagent_home_1.resolveKagentHome)({}), /HOME.*required/i);
    strict_1.default.throws(() => (0, kagent_home_1.resolveKagentHome)({ HOME: "   " }), /HOME.*required/i);
